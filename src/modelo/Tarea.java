...
public class Tarea {//Clase tarea principal
	...
	public Tarea(int id_tarea_proyecto,Proyecto proyec,Catalogo_tareas catalog,int id_tarea_padre,
	...
	public Tarea(String nombre_visible,boolean activa) {
		this.nombre_visible=nombre_visible;
		this.activa=activa;
	}
}
