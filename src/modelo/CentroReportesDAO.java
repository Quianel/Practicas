...
public class CentroReportesDAO {
	...
	public int obtenerHorasTotalesConFiltro(String proyectoSeleccionado) {
		Connection conexion;
		Statement consulta;
	...
	public int obtenerHorasAsignadasConFiltro(String proyectoSeleccionado) {
		Connection conexion;
		Statement consulta;
		ResultSet registro = null;
		int HorasAsignadas = 0;
	...
	public void TablaProyectosActivosConFiltro(DefaultTableModel modelotabla, String proyectoSeleccionado) {
		Connection conexion;
		Statement consulta;
		ResultSet registro = null;
		int Proyectos_Activos = 0;
	...
	public void TablaTrabajadoresActivosConFiltro(DefaultTableModel modelotabla, String proyectoSeleccionado) {
		Connection conexion;
		Statement consulta;
		ResultSet registro = null;
		int Trabajadores_Activos = 0;
