...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 11-05-2026 a las 19:56:33
...
(2, 2, 3, '2026-05-05', '2026-06-05', 'motivo', 1);
...
(1, 1, 1, '2026-06-05', '2026-06-05', 'motivo', 1),
(2, 2, 2, '2026-05-05', '2026-05-29', 'motivo', 1),
(3, 1, 2, '2026-05-05', '2026-05-29', 'motivo', 1),
(4, 1, 3, '2026-05-05', '2026-05-29', 'motivo', 1);
...
(2, 'MAN', 'Prueba', '2026-05-09', '2026-05-31', 0, 2, 1, 'MANTENIMENTO'),
(3, 'SER', 'Prueba Servicios', '2026-05-14', '2026-05-22', 1, 3, 1, 'SERVICIOS'),
(4, 'SER', 'SER', '2026-05-09', '2026-05-22', 1, 3, 1, 'SiSTEMA');
...
CREATE TABLE `tarea_proyecto` (
  ...
  `nombre_visible` varchar(100) DEFAULT NULL,
  `activa` tinyint(1) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(1, 1, 1, 1, 5, 'Tarea proyecto 1', 1),
(2, 2, 2, 1, 1, 'Mantenimiento de Usuario', 1),
(3, 1, 1, 3, 2, 'Crear usuarios', 1),
(4, 3, 3, 4, 3, 'gestionar los proyectos', 1);
...
(2, 'Alvaro_Administrador', 'Alvaro_Administrador@prueba.com', '$2a$10$mRoX9DiV60RhP.r6xLNmJORNhzwJ0dpVSlK1GvxZlTlcVtHgNnHNO', 1, 1, 2, 1),
(3, 'Manolo_trabajador', 'Manolo_trabajador@prueba.com', '$2a$10$mRoX9DiV60RhP.r6xLNmJORNhzwJ0dpVSlK1GvxZlTlcVtHgNnHNO', 1, 2, 3, 2),
(4, 'Manuela_Administrador', 'Manuela_Administrador@prueba.com', '$2a$10$mRoX9DiV60RhP.r6xLNmJORNhzwJ0dpVSlK1GvxZlTlcVtHgNnHNO', 0, 1, 4, 2);
...
--
ALTER TABLE `asignacion_tarea`
  MODIFY `id_asignacion_tarea` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `proyecto`
  MODIFY `id_proyecto` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `tarea_proyecto`
  MODIFY `id_tarea_proyecto` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
